...
function Index() {
    ...
    const [headerProfileVisible, setHeaderProfileVisible] = useState(false);
    return (
        <div>
            <p id="warning">
                        ...
                        <div className="logged-in">
                                ...
                                <a
                                    ...
                                    onClick={(e) => {
                                        ...
                                        const handleClickOutside = (e) => {
                                            if (e.target !== createPost && !createPost.contains(e.target)) {
                                                setCreatePostVisible(false);
                                                window.removeEventListener("mouseup", handleClickOutside);
                                            }
                                        };

                                        if (!createPostVisible) window.addEventListener("mouseup", handleClickOutside);
                                    }}
                                >
                                    <img src="/create-icon.png"></img>
                                    <img src="/drop-down.png"></img>
                                </a>
                                <div id="create-post-drop" style={{ display: createPostVisible ? "flex" : "none" }}>
                                    <ul>
                                        <li>
                                            <a href="/createPost?current=spotlight">
                                                <img src="/spotlight.png"></img>
                                                <p>Create Spotlight</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/createPost?current=property">
                                                <img src="/house.png"></img>
                                                <p>Create Listing</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/createPost?current=portfolio">
                            ...
                            <div className="header-profile-container">
                                <a
                                    ...
                                    onClick={(e) => {
                                        const headerProfileContainer = document.querySelector(".header-profile-container");
                                        setHeaderProfileVisible(!headerProfileVisible);

                                        const handleClickOutside = (e) => {
                                            if (e.target !== headerProfileContainer && !headerProfileContainer.contains(e.target)) {
                                                setHeaderProfileVisible(false);
                                                window.removeEventListener("mouseup", handleClickOutside);
                                            }
                                        };

                                        if (!headerProfileVisible) window.addEventListener("mouseup", handleClickOutside);
                                    }}
                                >
                                ...
                                <div id="signInHeaderInfo" style={{ display: headerProfileVisible ? "flex" : "none" }}>
